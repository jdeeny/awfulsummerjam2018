...
function FilmPage:initialize(w, h)
  ...
  self.details_panel = Widgets.Panel:new(colw, rowh, "DETAILS")
  self.cast_heading = Widgets.TextPanel:new(colw/2,1, Palette.HighlightText,"Cast", {center=true})
  self.crew_heading = Widgets.TextPanel:new(colw/2,1, Palette.HighlightText, "Crew", {center=true})
  self.keywords_heading = Widgets.TextPanel:new(row1+3,colw/2,1, Palette.HighlightText, "Keywords", {center=true})
  self.performance_heading = Widgets.TextPanel:new(colw/2,1, Palette.HighlightText, "Performance", {center=true})
  ...
  self.sequel_button = Widgets.Button:new(colw-8, 5, "Make Sequel", {
    onclick=make_sequel,
  })
